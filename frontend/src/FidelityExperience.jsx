  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-black overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-xs sm:max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto px-2 sm:px-4 py-8 sm:py-12 flex flex-col items-center">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-yellow-300 mb-4 sm:mb-6 text-center border-b-4 border-yellow-300 pb-2 w-full tracking-wider drop-shadow-lg">Software Developer Intern – Fidelity International</h1>
        <p className="text-base sm:text-lg md:text-xl text-white/90 mb-2 sm:mb-4 text-center font-semibold">Jan 2025 – Present</p>
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-yellow-200 mb-2 sm:mb-4 mt-6 sm:mt-10 text-center border-b-2 border-yellow-200 pb-1 w-full max-w-xs">Learning</h2>
        <ul className="text-xs sm:text-base md:text-lg text-white/90 mb-6 sm:mb-8 space-y-2 sm:space-y-3 list-none max-w-2xl">
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-yellow-200 mb-2 sm:mb-4 mt-6 sm:mt-10 text-center border-b-2 border-yellow-200 pb-1 w-full max-w-xs">My Experience & Reflections</h2>
        <ul className="text-xs sm:text-base md:text-lg text-white/90 mb-6 sm:mb-8 space-y-2 sm:space-y-3 list-none max-w-2xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-6 sm:mt-8 items-center justify-center">
          <img src={p4} alt="Team" className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 object-cover rounded-2xl shadow-2xl border-4 border-yellow-200 bg-white/20" />
          <img src={p9} alt="Work" className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 object-cover rounded-2xl shadow-2xl border-4 border-yellow-200 bg-white/20" />
        </div>
      </div>
      <style>{`
