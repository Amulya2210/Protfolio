  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-black overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto px-4 py-12 sm:py-20 flex flex-col items-center">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-yellow-300 mb-6 text-center border-b-4 border-yellow-300 pb-2 w-full tracking-wider drop-shadow-lg">Assistant Coordinator – Khwaab</h1>
        <p className="text-lg text-white/90 mb-6 text-center font-semibold">KIIT's Biggest Student-Run Society for Social Impact</p>
        <p className="text-base sm:text-lg text-white/90 mb-8 text-center max-w-2xl">
        ...
        <ul className="text-base sm:text-lg text-white/90 mb-8 space-y-4 list-none max-w-2xl">
        ...
        <div className="flex flex-col items-center gap-4">
          <img src={p7} alt="Khwaab Event" className="w-48 h-48 object-cover rounded-2xl shadow-2xl border-4 border-yellow-200 bg-white/20 cursor-pointer hover:scale-105 transition" onClick={() => setShowCert(true)} title="Click to view certificate" />
          <span className="text-xs text-yellow-200 italic">Click the photo to view certificate</span>
        </div>
        {showCert && (
